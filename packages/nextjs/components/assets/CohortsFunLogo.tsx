export const CohortsFunLogo = ({ className }: { className?: string }) => {
  return (
    <svg
      className={className}
      version="1.1"
      ...
      width="191px"
      height="72.3px"
      viewBox="0 0 191 72.3"
      xmlSpace="preserve"
    >
      <g>
        <g>
          <path
            fill="var(--logo-color, #86f644)"
            d="M87.2,39.5c-0.8-0.7-1.3-1.9-1.3-3.3v-9.4c0-1.5,0.4-2.6,1.3-3.3c0.8-0.7,2-1.1,3.6-1.1h3.8v2
          ...
          <path
            fill="var(--logo-color, #86f644)"
            d="M108.1,39.6c-0.7,0.7-1.9,1-3.5,1h-0.9c-1.6,0-2.7-0.3-3.5-1s-1.1-1.7-1.1-3.2v-4.7
          ...
          <path
            fill="var(--logo-color, #86f644)"
            d="M115.4,22.3v5.8c0.5-0.3,1.2-0.5,2-0.5h1.2c1.5,0,2.5,0.3,3.3,1c0.7,0.7,1.1,1.7,1.1,3.2v8.9
          ...
          <path
            fill="var(--logo-color, #86f644)"
            d="M135.9,39.6c-0.7,0.7-1.9,1-3.5,1h-0.9c-1.6,0-2.7-0.3-3.5-1c-0.7-0.7-1.1-1.7-1.1-3.2v-4.7
          ...
          <path
            fill="var(--logo-color, #86f644)"
            d="M143.2,38.7v-9.2h-2v-2h4.1v0.7c0.6-0.5,1.3-0.7,2.2-0.7h2.8v2.1h-3c-0.6,0-1,0.2-1.3,0.5
			c-0.3,0.4-0.4,0.7-0.5,1.1v7.4h2.9v2h-7.2v-2H143.2z"
          />
          <path
            fill="var(--logo-color, #86f644)"
            d="M158.6,39.8c-0.5-0.6-0.7-1.3-0.7-2.3v-8h-2.6v-2h2.6v-3.1h2.3v3.1h3.9v2h-3.9v8.1
			c0,0.4,0.1,0.7,0.3,0.8c0.2,0.2,0.5,0.2,0.9,0.2h2.7v2h-3.4C159.8,40.6,159.1,40.3,158.6,39.8z"
          />
          <path
            fill="var(--logo-color, #86f644)"
            d="M176.7,39.8c-0.7,0.5-1.7,0.8-3,0.8h-4v-2h4.3c0.5,0,0.9-0.1,1.1-0.3c0.3-0.2,0.4-0.5,0.4-0.9
          ...
          />
          <path fill="var(--logo-color, #86f644)" d="M87.9,54.8v1.8H86v-1.8H87.9z" />
          <path
            fill="var(--logo-color, #86f644)"
            d="M96.9,45.2c-0.1,0.1-0.2,0.2-0.2,0.4v1.8h3.1v1.4h-3.1v6.5H99v1.4h-5.5v-1.4h1.6v-6.5h-1.6
			v-1.4h1.6v-1.7c0-0.6,0.2-1.1,0.6-1.5c0.4-0.4,0.8-0.5,1.4-0.5h2.9v1.4h-2.6C97.2,45.1,97,45.1,96.9,45.2z"
          />
          <path
            fill="var(--logo-color, #86f644)"
            d="M106.9,56.6h-0.6c-1,0-1.8-0.2-2.3-0.7c-0.5-0.5-0.8-1.2-0.8-2.3v-6.3h1.6V54
          ...
          <path
            fill="var(--logo-color, #86f644)"
            d="M114.4,47.4v0.4c0.4-0.3,0.9-0.4,1.5-0.4h0.9c1,0,1.8,0.2,2.3,0.7c0.5,0.5,0.8,1.2,0.8,2.3
        ...
        <g>
          <path
            fill="var(--logo-color, #86f644)"
            d="M72,21.9h-9v8.5h-3.9V16.6l-6.1-3l-6.2,3v13.8h-4.1v-8.5h-9.3c-1.8,0-3.2,1.5-3.2,3.2v28.7
