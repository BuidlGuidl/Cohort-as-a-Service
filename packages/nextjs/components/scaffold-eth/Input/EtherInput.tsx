...
export const EtherInput = ({
  ...
  const handleChangeNumber = (newValue: string) => {
    ...
    // Track the current display value to preserve exact string representation
    // This handles trailing zeros and decimal points
  ...
  return (
    <InputBase
      ...
      disabled={disabled}
      prefix={<span className="pl-4 -mr-2 text-accent self-center fixed">{displayUsdMode ? "$" : "Ξ"}</span>}
      suffix={
        <div
          className={`${
