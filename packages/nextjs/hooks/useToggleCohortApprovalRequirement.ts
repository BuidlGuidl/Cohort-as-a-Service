...
interface UseToggleCohortApprovalRequirementProps {
  cohortAddress: string;
  requiresApproval: boolean;
}

export const useToggleCohortApprovalRequirement = ({
  cohortAddress,
  requiresApproval,
}: UseToggleCohortApprovalRequirementProps) => {
      ...
      try {
        const makeWriteWithParams = () =>
          writeContractAsync({
            ...
            functionName: "toggleContractApprovalRequirement",
  ...
  return {
    toggleCohortApprovalRequiremnt: sendContractWriteTx,
    isPending,
    isSuccess,
  };
};
